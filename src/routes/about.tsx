...
import { Target, Code2, Server, Database, LifeBuoy } from "lucide-react";
...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "关于我们 — Lione Apps" },
      { property: "og:description", content: "了解 Lione Apps 的使命、能力与服务。" },
    ],
  }),
  component: AboutPage,
});
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="mt-3 text-muted-foreground leading-relaxed">
                帮助组织将日常业务流程数字化,建立属于自己的管理平台,
                把精力放在真正重要的事工和业务上,而不是繁琐的行政记录。
              </p>
            </div>
          </div>
        </div>
